...
public class Configuration {
    ...
    private static final Map<String, Byte> letterQualities = new HashMap<>();
    static {
    ...
    public static byte getScore(final String letter) {
        Byte result = letterScores.get(letter);
        return result != null ? result : 0;
    }

    public static byte getQuantity(final String letter) {
        Byte result = letters.get(letter);
        return result != null ? result : 0;
    }

    public static byte getQuality(final String letter) {
        Byte result = letterQualities.get(letter);
        return result != null ? result : 0;
    }

    public static Set<String> getAllLetters() {
