...
ReactDOM.render(React.createElement(Scrabble, null), document.getElementById('main'));

},{"./components/Scrabble":6,"react":197,"react-dom":41}],2:[function(require,module,exports){
'use strict';
...
},{"alt":26,"alt/utils/chromeDebug":38}],3:[function(require,module,exports){
'use strict';
...
var Cell = React.createClass({
    ...
    rightClicked: function rightClicked(event) {
        event.preventDefault();
    ...
    render: function render() {
        var row = this.props.row,
            col = this.props.col,
            className = 'cell ' + (this.props.state == 'UNALLOWED' ? 'UNALLOWED' : '') + ' ' + (this.props.bonus == 'NONE' ? '' : this.props.bonus);
...
},{"../flux/actions/Actions":7,"../flux/stores/GameStore":11,"react":197}],4:[function(require,module,exports){
'use strict';
...
var ControlPanel = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            'div',
            { className: 'rack' },
            React.createElement(ButtonGo, { enabled: this.props.enabled })
        );
    }
});
...
var Tile = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            'div',
            { className: 'tile', draggable: 'true', onDragStart: this.drag },
            this.props.letter
        );
    }
});
...
var Rack = React.createClass({
    ...
    componentDidMount: function componentDidMount() {
        // todo implement me!
        RackStore.getRack(['Ё', 'Ё', '?'].reduce(function (prev, next) {
            return prev + next;
        }, ''));
    },
    render: function render() {
        return React.createElement(
            'div',
            { className: 'rack' },
            this.props.letters.filter(function (tile) {
                return !tile.hidden;
            }).map(function (tile, i) {
                return React.createElement(Tile, { letter: tile.letter, score: tile.score, key: i });
            })
        );
    }
});
...
},{"../flux/stores/RackStore":12,"react":197}],6:[function(require,module,exports){
'use strict';
...
},{"../flux/stores/ControlStore":10,"../flux/stores/GameStore":11,"../flux/stores/RackStore":12,"./Cells":3,"./ControlPanel":4,"./Rack":5,"alt-container":13,"react":197}],7:[function(require,module,exports){
'use strict';
...
var Actions = function () {
    ...
    _createClass(Actions, [{
        key: 'getRack',
        value: function getRack(rack) {
            this.dispatch(rack);
        }
    }, {
        key: 'tileDropped',
        value: function tileDropped(tile) {
            this.dispatch(tile);
        }
    }, {
        key: 'tileReverted',
        value: function tileReverted(letter) {
...
},{"../../alt":2}],8:[function(require,module,exports){
'use strict';
...
},{"../actions/Actions":7}],9:[function(require,module,exports){
'use strict';
...
var RackSource = {
    getRack: function getRack() {
        return {
            remote: function remote(state, letters) {
...
},{"../actions/Actions":7}],10:[function(require,module,exports){
'use strict';
...
},{"../../alt":2,"../actions/Actions":7,"../sources/GameSource":8}],12:[function(require,module,exports){
'use strict';
...
var RackStore = function () {
    function RackStore() {
        _classCallCheck(this, RackStore);
    ...
    _createClass(RackStore, [{
        key: 'handleGetRack',
        value: function handleGetRack(letters) {
            this.letters = letters;
        }
    }, {
        key: 'handleTileDropped',
        value: function handleTileDropped(letter) {
            var index = this.letters.findIndex(function (tile) {
                return tile.letter == letter.letter;
            });
            this.letters[index].hidden = true;
        }
    }, {
        key: 'handleTileReverted',
        value: function handleTileReverted(letter) {
            var index = this.letters.findIndex(function (tile) {
                return tile.hidden && tile.letter == letter.letter;
            });
...
},{"../../alt":2,"../actions/Actions":7,"../sources/RackSource":9}],13:[function(require,module,exports){
/*eslint-disable*/
/**
 * AltContainer.
 *
...
},{"object.assign":16,"react":197}],14:[function(require,module,exports){
'use strict';
...
},{"object-keys":21}],15:[function(require,module,exports){
'use strict';
...
},{"./hasSymbols":14,"function-bind":20,"object-keys":21}],16:[function(require,module,exports){
'use strict';
...
},{"./implementation":15,"./polyfill":23,"./shim":24,"define-properties":17}],17:[function(require,module,exports){
'use strict';
...
},{"foreach":18,"object-keys":21}],18:[function(require,module,exports){
...
},{"./implementation":15}],24:[function(require,module,exports){
'use strict';
...
},{"./polyfill":23,"define-properties":17}],25:[function(require,module,exports){
'use strict';
...
exports['default'] = Alt;
module.exports = exports['default'];
},{"../utils/functions":39,"./actions":25,"./store":29,"./symbols/symbols":30,"./utils/AltUtils":31,"./utils/StateFunctions":32,"flux":35}],27:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../../utils/functions":39,"../symbols/symbols":30,"es-symbol":33,"eventemitter3":34}],28:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../../utils/functions":39,"../symbols/symbols":30,"es-symbol":33}],29:[function(require,module,exports){
'use strict';
...
},{"../../utils/functions":39,"../symbols/symbols":30,"../utils/AltUtils":31,"./AltStore":27,"./StoreMixin":28,"eventemitter3":34}],30:[function(require,module,exports){
'use strict';
...
},{"../../utils/functions":39,"../symbols/symbols":30}],33:[function(require,module,exports){
"use strict";
...
},{"./CSSProperty":44,"./ReactPerf":112,"./dangerousStyleValue":146,"_process":40,"fbjs/lib/ExecutionEnvironment":171,"fbjs/lib/camelizeStyleName":173,"fbjs/lib/hyphenateStyleName":184,"fbjs/lib/memoizeStringOnly":191,"fbjs/lib/warning":196}],46:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":63,"./PooledClass":64,"_process":40,"fbjs/lib/invariant":185}],47:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":52,"./ReactMultiChildUpdateTypes":108,"./ReactPerf":112,"./setInnerHTML":165,"./setTextContent":166,"_process":40,"fbjs/lib/invariant":185}],50:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":40,"fbjs/lib/invariant":185}],51:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":50,"./ReactPerf":112,"./quoteAttributeValueForBrowser":163,"_process":40,"fbjs/lib/warning":196}],52:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":40,"fbjs/lib/ExecutionEnvironment":171,"fbjs/lib/createNodesFromMarkup":176,"fbjs/lib/emptyFunction":177,"fbjs/lib/getMarkupWrap":181,"fbjs/lib/invariant":185}],53:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventPluginRegistry":57,"./EventPluginUtils":58,"./ReactErrorUtils":97,"./accumulateInto":143,"./forEachAccumulated":151,"_process":40,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],57:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":40,"fbjs/lib/invariant":185}],58:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":55,"./ReactErrorUtils":97,"_process":40,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],59:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":55,"./EventPluginHub":56,"./accumulateInto":143,"./forEachAccumulated":151,"_process":40,"fbjs/lib/warning":196}],60:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypeLocations":114,"./ReactPropTypes":115,"_process":40,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],63:[function(require,module,exports){
/**
...
},{"_process":40,"fbjs/lib/invariant":185}],65:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactInstanceMap":103,"./findDOMNode":149,"_process":40,"fbjs/lib/warning":196}],67:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactReconciler":117,"./instantiateReactComponent":159,"./shouldUpdateReactComponent":167,"./traverseAllChildren":168,"_process":40,"fbjs/lib/warning":196}],69:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"./ReactComponent":71,"./ReactElement":93,"./ReactNoopUpdateQueue":110,"./ReactPropTypeLocationNames":113,"./ReactPropTypeLocations":114,"_process":40,"fbjs/lib/emptyObject":178,"fbjs/lib/invariant":185,"fbjs/lib/keyMirror":188,"fbjs/lib/keyOf":189,"fbjs/lib/warning":196}],71:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactNoopUpdateQueue":110,"./canDefineProperty":145,"_process":40,"fbjs/lib/emptyObject":178,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],72:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":40,"fbjs/lib/invariant":185}],74:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":93,"./ReactElementValidator":94,"_process":40,"fbjs/lib/mapObject":190}],80:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":49,"./DOMPropertyOperations":51,"./ReactMount":106,"./ReactPerf":112,"_process":40,"fbjs/lib/invariant":185}],82:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":62,"./Object.assign":63,"./ReactDOMIDOperations":81,"./ReactMount":106,"./ReactUpdates":124,"_process":40,"fbjs/lib/invariant":185}],83:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":63,"./ReactChildren":69,"./ReactDOMSelect":84,"_process":40,"fbjs/lib/warning":196}],84:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":62,"./Object.assign":63,"./ReactMount":106,"./ReactUpdates":124,"_process":40,"fbjs/lib/warning":196}],85:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./LinkedValueUtils":62,"./Object.assign":63,"./ReactDOMIDOperations":81,"./ReactUpdates":124,"_process":40,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],89:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./BeforeInputEventPlugin":43,"./ChangeEventPlugin":47,"./ClientReactRootIndex":48,"./DefaultEventPluginOrder":53,"./EnterLeaveEventPlugin":54,"./HTMLDOMPropertyConfig":61,"./ReactBrowserComponentMixin":66,"./ReactComponentBrowserEnvironment":72,"./ReactDOMComponent":78,"./ReactDOMTextComponent":87,"./ReactDefaultBatchingStrategy":89,"./ReactDefaultPerf":91,"./ReactEventListener":99,"./ReactInjection":100,"./ReactInstanceHandles":102,"./ReactMount":106,"./ReactReconcileTransaction":116,"./SVGDOMPropertyConfig":126,"./SelectEventPlugin":127,"./ServerReactRootIndex":128,"./SimpleEventPlugin":129,"_process":40,"fbjs/lib/ExecutionEnvironment":171}],91:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":75,"./ReactElement":93,"./ReactPropTypeLocationNames":113,"./ReactPropTypeLocations":114,"./canDefineProperty":145,"./getIteratorFn":156,"_process":40,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],95:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":119,"_process":40,"fbjs/lib/invariant":185}],103:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"_process":40,"fbjs/lib/invariant":185}],110:[function(require,module,exports){
(function (process){
/**
...
},{"_process":40,"fbjs/lib/warning":196}],111:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":40,"fbjs/lib/invariant":185}],112:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":63,"./ReactCurrentOwner":75,"./ReactElement":93,"./ReactInstanceMap":103,"./ReactUpdates":124,"_process":40,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],124:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":46,"./Object.assign":63,"./PooledClass":64,"./ReactPerf":112,"./ReactReconciler":117,"./Transaction":141,"_process":40,"fbjs/lib/invariant":185}],125:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"./PooledClass":64,"_process":40,"fbjs/lib/emptyFunction":177,"fbjs/lib/warning":196}],134:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":40,"fbjs/lib/invariant":185}],142:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":40,"fbjs/lib/invariant":185}],144:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"_process":40,"fbjs/lib/warning":196}],148:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":75,"./ReactInstanceMap":103,"./ReactMount":106,"_process":40,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],150:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":168,"_process":40,"fbjs/lib/warning":196}],151:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"./ReactCompositeComponent":74,"./ReactEmptyComponent":95,"./ReactNativeComponent":109,"_process":40,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],160:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":93,"_process":40,"fbjs/lib/invariant":185}],163:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":75,"./ReactElement":93,"./ReactInstanceHandles":102,"./getIteratorFn":156,"_process":40,"fbjs/lib/invariant":185,"fbjs/lib/warning":196}],169:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":63,"_process":40,"fbjs/lib/emptyFunction":177,"fbjs/lib/warning":196}],170:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 *
...
},{"./emptyFunction":177,"_process":40}],171:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":171,"./createArrayFromMixed":175,"./getMarkupWrap":181,"./invariant":185,"_process":40}],177:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":171,"./invariant":185,"_process":40}],182:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":40}],186:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":185,"_process":40}],189:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":185,"_process":40}],196:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./emptyFunction":177,"_process":40}],197:[function(require,module,exports){
'use strict';
